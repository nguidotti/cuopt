...
struct simplex_solver_settings_t {
 public:
  ...
  i_t group_cover_cuts;            // 0 to disable, >0 to enable group cover cuts
  i_t activated_capacity_cuts;     // 0 to disable, >0 to enable activated capacity cuts
